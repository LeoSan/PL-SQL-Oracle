...
/*2466*/    left join PENDUPM.comprobaciongasto com on gas.idgasto = com.idgasto AND com.IDTPOGASTO  in (7,8) 
...
/*2583*/    left join PENDUPM.FACTURACIONMAIN fm on FA.IDGASTOMAIN = fm.IDGASTOMAIN AND  fm.FCSTATUS NOT IN ('Z') 
